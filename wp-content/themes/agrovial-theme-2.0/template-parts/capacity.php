...
$capacity_items = [
    [
        ...
        'title' => get_option('capacity_1_title', 'Capacidad Operativa'),
        'desc'  => get_option('capacity_1_desc', 'Flota de más de 70 rodados, maquinaria propia y estructura operativa para ejecutar obras de infraestructura en distintos puntos de la provincia.'),
    ],
    [
        ...
        'value' => get_option('capacity_2_value', '+25 Años'),
        'title' => get_option('capacity_2_title', 'Experiencia en Infraestructura'),
        'desc'  => get_option('capacity_2_desc', 'Participación en obras vinculadas a desarrollo urbano, industria y proyectos productivos.'),
    ],
    [
        ...
        'value' => get_option('capacity_3_value', 'Expertos'),
        'title' => get_option('capacity_3_title', 'Equipo Técnico Especializado'),
        'desc'  => get_option('capacity_3_desc', 'Profesionales y técnicos con experiencia en obras de infraestructura y desarrollo territorial.'),
    ],
    [
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-7 h-7 text-primary-foreground"><path d="M2 12h20"/><path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-6"/><path d="M12 2v20"/></svg>',
        'value' => get_option('capacity_4_value', 'Río Negro'),
        'title' => get_option('capacity_4_title', 'Presencia Provincial'),
        'desc'  => get_option('capacity_4_desc', 'Obras ejecutadas en distintas localidades de Río Negro, acompañando el crecimiento productivo de la región.'),
    ],
];
?>
