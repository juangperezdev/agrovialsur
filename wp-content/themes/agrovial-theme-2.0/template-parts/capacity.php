...
$capacity_items = [
    [
        ...
        'value' => get_theme_mod('capacity_1_value', '+70'),
        'title' => get_theme_mod('capacity_1_title', 'Rodados'),
        'desc'  => get_theme_mod('capacity_1_desc', 'Flota propia de más de 70 vehículos y equipos pesados para operar en simultáneo en múltiples proyectos.'),
    ],
    [
        ...
        'value' => get_theme_mod('capacity_2_value', '100%'),
        'title' => get_theme_mod('capacity_2_title', 'Maquinaria Propia'),
        'desc'  => get_theme_mod('capacity_2_desc', 'Operamos con maquinaria propia de última generación, garantizando disponibilidad inmediata y control total de costos.'),
    ],
    [
        ...
        'value' => get_theme_mod('capacity_3_value', '24/7'),
        'title' => get_theme_mod('capacity_3_title', 'Taller'),
        'desc'  => get_theme_mod('capacity_3_desc', 'Taller propio con capacidad de mantenimiento preventivo y correctivo para minimizar tiempos de inactividad.'),
    ],
    [
        ...
        'value' => get_theme_mod('capacity_4_value', '150+'),
        'title' => get_theme_mod('capacity_4_title', 'Equipo Técnico'),
        'desc'  => get_theme_mod('capacity_4_desc', 'Equipo multidisciplinario de ingenieros, técnicos y operarios altamente capacitados con experiencia en grandes obras.'),
    ],
];
?>
