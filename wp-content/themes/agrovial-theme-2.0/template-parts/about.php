<?php
$about_badge = get_theme_mod('about_badge', 'Sobre Nosotros');
$about_title = get_theme_mod('about_title', 'CONSTRUYENDO EXCELENCIA');
$about_text = get_theme_mod('about_text', 'Desde 1999, hemos sido pioneros en la construcción de infraestructura vial de alta calidad. Nuestro compromiso con la excelencia nos ha posicionado como líderes en el sector.');
$about_text_2 = get_theme_mod('about_text_2', 'Trabajamos con gobiernos, municipios y empresas privadas para desarrollar proyectos que transforman comunidades y mejoran la conectividad regional. Cada kilómetro construido representa nuestra dedicación a la calidad y la innovación.');

$stat1_val = get_theme_mod('about_stat_1_val', '99%');
$stat1_label = get_theme_mod('about_stat_1_label', 'Entregas a tiempo');
$stat2_val = get_theme_mod('about_stat_2_val', 'ISO 9001');
$stat2_label = get_theme_mod('about_stat_2_label', 'Certificación');
$stat3_val = get_theme_mod('about_stat_3_val', '15');
$stat3_label = get_theme_mod('about_stat_3_label', 'Estados cubiertos');
...
$features = [
    [
        ...
        'title' => get_theme_mod('about_feat_1_title', 'Seguridad Garantizada'),
        'description' => get_theme_mod('about_feat_1_desc', 'Cumplimos con las normas más estrictas de seguridad vial internacional.')
    ],
    [
        ...
        'title' => get_theme_mod('about_feat_2_title', 'Tecnología Avanzada'),
        'description' => get_theme_mod('about_feat_2_desc', 'Utilizamos maquinaria de última generación para optimizar tiempos y costos.')
    ],
    [
        ...
        'title' => get_theme_mod('about_feat_3_title', 'Sostenibilidad'),
        'description' => get_theme_mod('about_feat_3_desc', 'Procesos optimizados para minimizar el impacto ambiental en cada obra.')
    ],
    [
        ...
        'title' => get_theme_mod('about_feat_4_title', 'Equipo Experto'),
        'description' => get_theme_mod('about_feat_4_desc', 'Ingenieros y técnicos altamente capacitados con años de experiencia.')
    ]
];
?>
