...
$infra_items = [
    [
        ...
        'desc'  => get_option('infra_1_desc', 'Infraestructura para plantas industriales y desarrollo productivo.'),
    ],
    [
        ...
        'desc'  => get_option('infra_2_desc', 'Obras de infraestructura vinculadas a proyectos extractivos.'),
    ],
    [
        ...
        'desc'  => get_option('infra_3_desc', 'Infraestructura para urbanizaciones y desarrollo territorial.'),
    ],
];
?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 class="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-4">
                INFRAESTRUCTURA PARA EL <span class="text-gradient">CRECIMIENTO PRODUCTIVO DE LA PROVINCIA</span>
            </h2>
