...
$infra_items = [
    [
        ...
        'title' => get_theme_mod('infra_1_title', 'Industria'),
        'desc'  => get_theme_mod('infra_1_desc', 'Desarrollamos infraestructura industrial de alta calidad para impulsar la productividad regional. Plantas, naves industriales y accesos.'),
    ],
    [
        ...
        'title' => get_theme_mod('infra_2_title', 'Minería'),
        'desc'  => get_theme_mod('infra_2_desc', 'Proveemos soluciones de infraestructura para el sector minero: caminos de acceso, plataformas de exploración y obras complementarias.'),
    ],
    [
        ...
        'title' => get_theme_mod('infra_3_title', 'Desarrollo Urbano'),
        'desc'  => get_theme_mod('infra_3_desc', 'Construimos la infraestructura necesaria para el crecimiento de las ciudades: pavimentación, redes de servicios y espacios públicos.'),
    ],
];
?>
